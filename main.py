...
print("""
Este código desenvolvido na linguagem Python explora o tema da física óptica da polarização da luz. Para 
a utilização do programa, primeiramente deve-se escolher entre as opções mostradas no menu, respondendo 
com o número correspondente ao cálculo desejado, e então as entradas requeridas, que variam de acordo com  
a opção. Desse modo, o programa é capaz de calcular a intensidade em todas as etapas com dois a três 
polarizadores.
""")
...
def calcPolarizai1(ang1, ang2, ang3, i1):
  ...
  if ang3 == 0:
    print(f'\nIntensidade inicial: {i0:.3}\nIntensidade 2: {i2:.3}')
  else:
    print(f'\nIntensidade inicial: {i0:.3} W/m^2\nIntensidade 2: {i2:.3} W/m^2\nIntensidade 3: {i3:.3} W/m^2')
